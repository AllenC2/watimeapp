  ...
  es: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'WhatsApp: archivos de sesión por usuario, número, nombre visible, plataforma e IDs de canales de los que es propietario. Al cerrar WhatsApp en el panel se busca borrar esa sesión del servidor.',
      ],
    },
    {
      title: '4. Finalidades',
  ...
  en: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'WhatsApp: per-user session files, number, display name, platform, and IDs of channels you own. Logging out of WhatsApp in the panel aims to delete that session from the server.',
      ],
    },
    {
      title: '4. Purposes',
