...
export const DEFAULT_LOGO_SRC = '/logos/watime-logo-extend.svg?v=2';
...
export const THEMES = [
  ...
  { id: 'olivo', label: 'Olivo', swatches: ['#16140d', '#9aaa52', '#c9a227'] },
...
export function applyTheme(theme) {
  ...
  document.documentElement.setAttribute('data-theme', isThemeId(theme) ? theme : 'dark');
}
